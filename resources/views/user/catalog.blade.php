        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="gallery_content">
                ...
                <div class="banner-btn discover-btn-banner text-center">
                    <a href="{{ route('user.cart.add', ['slug' => $package->packageSlug]) }}" class="btn btn-primary text-decoration-none" style="background-color: #7E4752; color: #fff;"><i class="fa fa-clipboard-list"></i> Tambahkan Ke Keranjang</a>
                </div>
            </div>
        </div>
        @endforeach
