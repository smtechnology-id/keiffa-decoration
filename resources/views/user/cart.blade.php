                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5" class="text-right">
                                ...
                                <a href="{{ route('user.additional') }}" class="btn btn-primary" style="background-color: #636F54; color: #fff;">Tambahkan Additional Package</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <form action="{{ route('user.checkout') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="wedding_location">Lokasi Pernikahan</label>
