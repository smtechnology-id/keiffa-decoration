	...
	<body class="home">
		...
		<div class="top-single-bkg topsinglepage">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title"> Contact 2</h1>
		...
		<div id="wrap-content" class="page-content custom-page-template">
			<!-- SECTION 1 -->
			<div id="contact-2-1" class="section-holder margin-notop100 contact-2-1">
				<div class="gmaps">
							...
							<div class="margin-r50">
								<div class="row">
									<div class="col-md-6">
										...
										<p>1-800-111-2222<br>1-800-111-3333</p>
										<h5 class="widgettitle">Main Office</h5>
										<p>40 Park Ave,<br> Brooklyn, New York</p>
									</div>
									<!-- /col-md-6 -->
									<div class="col-md-6">
										<h5 class="widgettitle">Email Us</h5>
										<p>contact@example.com<br>contact2@example.com</p>
