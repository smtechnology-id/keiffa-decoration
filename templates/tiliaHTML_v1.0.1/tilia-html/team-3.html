...
<html lang="en-US">
	...
	<body class="home">
		...
		<div class="top-single-bkg topsinglepage">
			<div class="topsingleimg"> <img src="images/pages/team-page.jpg" alt="" width="1920" height="1080"></div>
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Team 3</h1>
		...
		<div id="wrap-content" class="page-content page-holder custom-page-template page-full fullscreen-page clearfix">
			<!-- SECTION 1 -->
			<div id="team-3-1" class="section-holder team-3-1">
				<div class="container">
			...
			<!-- /SECTION 1 -->
			<!-- SECTION 2 -->
			<div id="team-3-2" class="section-holder team-3-2">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 tablet-margin-b50">
							<div class="el-smalltitle"> What We Do</div>
							<h2 class="display-4 margin-b30">Our Skills</h2>
			...
			<!-- /SECTION 2 -->
			<!-- SECTION 3 -->
			<div id="team-3-3" class="section-holder team-3-3 section-nomargin parallax" style="background-image:url(images/home/slider-1.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
