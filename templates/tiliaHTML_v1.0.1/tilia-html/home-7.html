...
<html lang="en-US">
	...
	<body class="home home-7 home-menu-black">
		<div class="menu-mask">
			<!-- MOBILE MENU HOLDER -->
		...
		<div id="wrap-content" class="page-content custom-page-template">
					...
					<div class="row">
						<div class="col-lg-12 alignc">
							<div class="padding-lr200">
								<img class="img-fluid img-circle width30 margin-b30" src="images/portfolio/gal-grid/gal-grid-08.jpg" alt=" " />
								<h2 class="display-4 margin-b30">Hi I'm April Ryan, a wedding photographer based in New York</h2>
			...
			<!-- SECTION 2 -->
			<div id="home-section-7-2" class="section-holder home-section-7-2">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
			...
			<!-- SECTION 3 -->
			<div id="home-section-7-3" class="section-holder home-section-7-3 section-info padding-tb100 section-nomargin">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
