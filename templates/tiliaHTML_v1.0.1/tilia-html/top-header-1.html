...
<html lang="en-US">
	<head>
		...
		<title>Top Header 1 - Tilia </title>
		<!-- Google Fonts -->
		...
		<header class="main-header header-1">
			<div class="container">
				<div class="header-container">
					<div class="logo logo-1 logo-white"><a href="index.html"><img class="img-fluid" src="images/logo-tilia.png" alt="Tilia" width="139" height="90"></a></div>
					<div class="logo logo-1 logo-dark"><a href="index.html"><img class="img-fluid" src="images/logo-dark-tilia.png" alt="Tilia" width="139" height="90"></a></div>
					...
					<div class="btn-header btn-header-1"> <a href="#" class="read-more">Book Now</a></div>
				</div>
			</div>
		</header>
		<!-- /HEADER -->
