...
<html lang="en-US">
	<head>
		...
		<title>Gallery Grid 5 Cols - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Gallery Grid 5 Cols</h1>
					<span class="post-subtitle">Timeless Photos</span>
				</div>
			</div>
		</div>
		<!-- /TOP HEADER IMAGE -->
		...
		<div id="wrap-content" class="page-content page-gallery-content">
			...
			<div class="gallery-container">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="portfolio-grid gallery-holder-grid gallery-grid5cols">
							
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-01.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-01.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
							
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-02.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-02.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-03.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-03.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-04.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-04.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-05.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-05.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-06.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-06.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-07.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-07.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-08.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-08.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-09.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-09.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-10.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-10.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-11.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-11.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-12.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-12.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/featured-images/gal-9-grid.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/featured-images/gal-9-grid.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/featured-images/gal-8-grid.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/featured-images/gal-8-grid.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
