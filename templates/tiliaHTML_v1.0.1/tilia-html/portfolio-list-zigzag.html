...
<html lang="en-US">
	<head>
		...
		<title>Portfolio List ZigZag - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Portfolio List ZigZag</h1>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="portfolio-list-container">
							<div class="item-list item-zigzag"><div class="item-text-holder item-text-list-holder"><h2 class="item-list-title display-3"><a href="gallery-masonry-3-cols.html">Tracy &amp; Aaron</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div><div class="item-list-image"><div class="item-list-image-left"><a href="gallery-masonry-3-cols.html"><img loading="lazy" src="images/portfolio/featured-images/gal-1-grid.jpg" class="img-list" alt=" " width="750" height="750"></a></div></div>
							</div>
								<!-- /item-portfolio -->
							<div class="item-list item-zigzag"><div class="item-text-holder item-text-list-holder"><h2 class="item-list-title display-3"><a href="gallery-masonry-4-cols.html">Jane &amp; Paul</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div><div class="item-list-image"><div class="item-list-image-left"><a href="gallery-masonry-4-cols.html"><img loading="lazy" src="images/portfolio/featured-images/gal-2-grid.jpg" class="img-list" alt=" " width="750" height="750"></a></div></div>
							</div>
								<!-- /item-portfolio -->
							<div class="item-list item-zigzag"><div class="item-text-holder item-text-list-holder"><h2 class="item-list-title display-3"><a href="gallery-grid-4-cols.html">Angela &amp; Zach</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div><div class="item-list-image"><div class="item-list-image-left"><a href="gallery-grid-4-cols.html"><img loading="lazy" src="images/portfolio/featured-images/gal-3-grid.jpg" class="img-list" alt=" " width="750" height="750"></a></div></div>
							</div>
								<!-- /item-portfolio -->
							<div class="item-list item-zigzag"><div class="item-text-holder item-text-list-holder"><h2 class="item-list-title display-3"><a href="gallery-grid-3-cols.html">Diana &amp; Max</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div><div class="item-list-image"><div class="item-list-image-left"><a href="gallery-grid-3-cols.html"><img loading="lazy" src="images/portfolio/featured-images/gal-4-grid.jpg" class="img-list" alt=" " width="750" height="750"></a></div></div>
							</div>
								<!-- /item-portfolio -->
							<div class="item-list item-zigzag"><div class="item-text-holder item-text-list-holder"><h2 class="item-list-title display-3"><a href="gallery-grid-4-cols.html">Tina &amp; Robi</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li><li><a href="#">Wedding</a></li></ul></div><div class="item-list-image"><div class="item-list-image-left"><a href="gallery-grid-4-cols.html"><img loading="lazy" src="images/portfolio/featured-images/gal-5-grid.jpg" class="img-list" alt=" " width="750" height="750"></a></div></div>
							</div>
								<!-- /item-portfolio -->	
							<div class="item-list item-zigzag"><div class="item-text-holder item-text-list-holder"><h2 class="item-list-title display-3"><a href="gallery-masonry-2-cols.html">Clara &amp; Andrew</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li><li><a href="#">Wedding</a></li></ul></div><div class="item-list-image"><div class="item-list-image-left"><a href="gallery-masonry-2-cols.html"><img loading="lazy" src="images/portfolio/featured-images/gal-6-grid.jpg" class="img-list" alt=" " width="750" height="750"></a></div></div>
							</div>
								<!-- /item-portfolio -->	
							<div class="item-list item-zigzag"><div class="item-text-holder item-text-list-holder"><h2 class="item-list-title display-3"><a href="gallery-masonry-3-cols.html">Street People</a></h2><ul class="portfolio-categ"><li><a href="#">Portrait</a></li></ul></div><div class="item-list-image"><div class="item-list-image-left"><a href="gallery-masonry-3-cols.html"><img loading="lazy" src="images/portfolio/featured-images/gal-7-grid.jpg" class="img-list" alt=" " width="750" height="750"></a></div></div>
							</div>
								<!-- /item-portfolio -->		
							<div class="item-list item-zigzag"><div class="item-text-holder item-text-list-holder"><h2 class="item-list-title display-3"><a href="gallery-grid-3-cols.html">Ballet Dancers</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li></ul></div><div class="item-list-image"><div class="item-list-image-left"><a href="gallery-grid-3-cols.html"><img loading="lazy" src="images/portfolio/featured-images/gal-8-grid.jpg" class="img-list" alt=" " width="750" height="750"></a></div></div>
							</div>
								<!-- /item-portfolio -->		
						</div>
