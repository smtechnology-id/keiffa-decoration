...
<html lang="en-US">
	...
	<body class="home home-9 home-menu-black">
		<div class="menu-mask">
			<!-- MOBILE MENU HOLDER -->
		...
		<div id="wrap-content" class="page-content custom-page-template">
			...
			<div id="home-section-9-1" class="section-holder home-section-9-1">
				<div class="container">
					<div class="row">
						<div class="col-lg-8">
							<h1>
							We're Tilia, a Wedding & Portrait Studio based in New York</h1>
						</div>
						<!-- /col-lg-8 -->	
					</div>
					<!-- /row -->	
			...
			<div id="home-section-9-2" class="section-holder home-section-9-2">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div id="portfolio-2cols-bigspace" class="portfolio-grid-container">
								<div class="portfolio-grid">
									<div class="item-portfolio item-2cols wedding">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-2cols lifestyle wedding">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-2cols portrait">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-2cols lifestyle">
			...
			<!-- /SECTION 2 -->
			<!-- SECTION 3 -->
			<div id="home-section-9-3" class="section-holder home-section-9-3">
				<div class="container">
