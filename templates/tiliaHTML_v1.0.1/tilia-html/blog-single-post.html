...
<html lang="en-US">
	<head>
		...
		<title>Blog Single Post - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg">
			<div class="topsingleimg"> <img src="images/blog/blog-8.jpg" alt=" " width="1400" height="1000"></div>
			<div class="inner-desc">
				<div class="container">
					<div class="meta-categ-all meta-info-single"><a href="#" rel="category tag">Street</a></div>
					<h1 class="display-2 single-post-title"> Blog Single Post</h1>
					...
					<div class="col-lg-9 posts-holder post-sidebar">
						<article class="blog-item-1col single-post-holder single-article-container">
							<div class="post-content single-post-content single-article-page clearfix">
								<p>Arnare varius mauris eu commodo. Aenean nibh risus, rhoncus eget consectetur ac. Consectetur adipiscing elit. Vivamus auctor condimentum sem et gravida. Maecenas id enim pharetra, sollicitudin dui eget, blandit lorem. Nunc vitae blandit lectus. Donec lacinia magna sit amet arcu aliquet luctus. Maecenas vehicula metus nisi, nec finibus justo vulputate eget. Pellentesque porta felis id erat sodales condimentum. Nam a lectus egestas, fermentum mi in, auctor lacus.</p>
								<h2>Gallery Block</h2>
								...
								<div class="row">
									<div class="col-md-6">
										<figure><a href="#"><img loading="lazy" src="images/blog/blog-9.jpg" alt="" class="img-fluid"></a></figure>
									</div>
									<div class="col-md-6">
										<figure><a href="#"><img loading="lazy" src="images/blog/blog-8.jpg" alt="" class="img-fluid"></a></figure>
									</div>
									<div class="col-md-6">
										<figure><a href="#"><img loading="lazy" src="images/blog/blog-7.jpg" alt="" class="img-fluid"></a></figure>
									</div>
									<div class="col-md-6">
										<figure><a href="#"><img loading="lazy" src="images/blog/blog-3.jpg" alt="" class="img-fluid"></a></figure>
									</div>
								</div>
							...
							<!-- /single-post-content -->		
							<div class="tags-single-page"> <a href="#" rel="tag">love</a> <a href="#" rel="tag">photos</a></div>
							<div class="row meta-nav-holder">
									...
									<div class="pn-desc">
										<div class="prev-next-title">
											<a href="#">
												...
												Lovely Engagement Photos of Sandra &amp; Peter
											</a>
										</div>
									</div>
								</div>
								<div class="col-md-6 meta-nav meta-nav-right  ">
									<div class="pn-desc">
										<div class="prev-next-title">
											<a href="#">
												Into the Forest: Katy Evening Dress 
												<svg id="arrow-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" style="enable-background:new 0 0 320 512;" xml:space="preserve">
													<path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z" class=""></path>
												</svg>
											</a>
								...
								<div class="author-single-page">
									<div class="author-avatar"> <img alt="" src="images/gravatar.jpg" class="avatar avatar-100 photo" loading="lazy" width="100" height="100"></div>
									<div class="author-content">
										<h3><a href="#"> April Ryan</a></h3>
										<div class="author-text"> Short bio here. Donec lacinia magna sit amet arcu aliquet luctus. Maecenas vehicula metus nisi, nec finibus justo vulputate eget. Pellentesque porta felis id erat sodales condimentum.</div>
									</div>
								</div>
								<!-- /author-single-page -->
							</div>
