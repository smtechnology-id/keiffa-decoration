...
<html lang="en-US">
	...
	<body class="home">
		...
		<div id="wrap-content" class="page-content page-holder custom-page-template page-full fullscreen-page clearfix">
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 margin-bm50">
							<img class="img-fluid" src="images/pages/faq-1.jpg" alt=" " />
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
								...
								<ul class="faq-list">
									...
									<li>
										...
										<div id="faq4" class="faq-section">
											<p>No vim quem impetus. Mea eu putent possim tamquam. Putant mentitum temporibus in eum, est et suas mutat assueverit, inani commodo accumsan mel in. Qui in epicuri postulant hendrerit, nec et veri harum eirmod.</p>
										</div>
									</li>
									<li>
										...
										<div id="faq5" class="faq-section">
											<p>Duis dicat eos ei. Eam quem dissentiunt reprehendunt in, in eos esse facete aeterno. Nec no intellegam neglegentur. Pri wisi delenit pertinacia et, mel id mundi simul. Legere consequuntur his id, eos ei nostro utamur. Eu discere legimus sed, te alii omittantur nec.</p>
										</div>
									</li>
								</ul>
							</div>
			...
			<!-- /SECTION 1 -->
			<!-- SECTION 2 -->
			<div id="faqpage-2" class="section-holder section-info faqpage-2">
