...
<html lang="en-US">
	<head>
		...
		<title>Gallery Masonry 2 Cols - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Gallery Masonry 2 Cols</h1>
					<span class="post-subtitle">Lovely Warm Sunny Day</span>
				</div>
			</div>
		</div>
		<!-- /TOP HEADER IMAGE -->
		...
		<div id="wrap-content" class="page-content page-gallery-content">
			...
			<div class="gallery-container">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="portfolio-masonry portfolio-layout-masonry gallery-holder-masonry gallery-masonry2cols">
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-01.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-01.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-03.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-03.jpg" alt="" title="" width="750" height="1000"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-04.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-04.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-05.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-05.jpg" alt="" title="" width="750" height="1000"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-06.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-06.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-07.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-07.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-02.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-02.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-08.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-08.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
							</div>
							<!-- /portfolio-masonry -->
