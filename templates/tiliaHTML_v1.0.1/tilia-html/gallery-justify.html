...
<html lang="en-US">
	<head>
		...
		<title>Gallery Justify - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Gallery Justify</h1>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="portfolio-grid gallery-holder-grid gallery-justify">
								...
								<div class="item-justify gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-01.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-01.jpg" alt="" title="" width="700" height="500"> </a></div>
								<!-- /item-portfolio -->
								
								<div class="item-justify gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-02.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-02.jpg" alt="" title="" width="375" height="500"> </a></div>
								<!-- /item-portfolio -->
								
								<div class="item-justify gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-03.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-03.jpg" alt="" title="" width="750" height="500"> </a></div>
								<!-- /item-portfolio -->
								
								<div class="item-justify gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-04.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-04.jpg" alt="" title="" width="750" height="500"> </a></div>
								<!-- /item-portfolio -->
								
								<div class="item-justify gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-05.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-05.jpg" alt="" title="" width="750" height="500"> </a></div>
								<!-- /item-portfolio -->
								
								<div class="item-justify gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-06.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-06.jpg" alt="" title="" width="700" height="500"> </a></div>
								<!-- /item-portfolio -->
								
								<div class="item-justify gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-07.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-07.jpg" alt="" title="" width="700" height="500"> </a></div>
								<!-- /item-portfolio -->
								
								<div class="item-justify gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-08.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-08.jpg" alt="" title="" width="375" height="500"> </a></div>
								<!-- /item-portfolio -->
