...
<html lang="en-US">
	<head>
		...
		<title>Gallery Masonry 5 Cols - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Gallery Masonry 5 Cols</h1>
					<span class="post-subtitle">Personal Project</span>
				</div>
			</div>
		</div>
		<!-- /TOP HEADER IMAGE -->
		...
		<div id="wrap-content" class="page-content page-gallery-content">
			<div class="container">
				<div class="page-holder custom-page-template page-full">
					<div class="margin-b50">
						Lacus ut nisi ultrices faucibus. Pellentesque porta felis id erat sodales condimentum. Nam a lectus egestas, fermentum mi in, auctor lacus. Fusce a enim vel neque. Morbi facilisis justo sit amet urna feugiat aliquam. Nullam faucibus sodales
						mi. Vivamus nisl lorem, vulputate id pellentesque non, tristique ac leo.
					</div>
				</div>
				<!-- /page-holder -->
			</div>
			...
			<div class="gallery-container">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="portfolio-masonry portfolio-layout-masonry gallery-holder-masonry gallery-masonry5cols">
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-01.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-01.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-02.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-02.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-03.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-03.jpg" alt="" title="" width="750" height="1000"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-04.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-04.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-05.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-05.jpg" alt="" title="" width="750" height="1000"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-06.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-06.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-07.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-07.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-08.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-08.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-09.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-09.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-01.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-01.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-03.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-03.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-04.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-04.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
								
								<div class="item-portfolio item-5cols gallery-post"> <a href="images/portfolio/gal-justify/gal-justify-05.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-justify/gal-justify-05.jpg" alt="" title="" width="750" height="500"> </a>
								</div>
								<!-- /item-portfolio -->
			...
			<div class="container prev-next-gallery">
				<div class="row meta-nav-holder port-meta-nav">
					<div class="col-md-6 meta-nav meta-nav-left">
						<div class="pn-holder">
							<div class="pn-img"> <a href="#"> <img class="img-fluid" src="images/portfolio/gal-grid/gal-grid-01.jpg" alt="Prev Gallery"> </a></div>
							<div class="pn-desc">
					...
					<div class="col-md-6 meta-nav meta-nav-right">
						<div class="pn-holder">
							...
							<div class="pn-img"> <a href="#"> <img class="img-fluid" src="images/portfolio/gal-grid/gal-grid-03.jpg" alt="Next Gallery"> </a></div>
						</div>
					</div>
				</div>
			</div>
