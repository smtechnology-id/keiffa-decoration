...
<html lang="en-US">
	<head>
		...
		<title>Portfolio Grid v2 5 Cols - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Portfolio Grid v2 5 Cols</h1>
		...
		<div id="wrap-content" class="page-content page-holder custom-page-template clearfix">
			<div class="portfolio-grid-container portfolio-grid-container-v2 portfolio-grid-container-fs">
				<div class="portfolio-grid portfolio-grid-v2 portfolio-layout-masonry">
					...
					<div class="item-portfolio item-portfolio-v2 item-5cols wedding">
						<div class="item-portfolio-holder-v2">
							<div class="post-image item-grid-image-v2"><img loading="lazy" src="images/portfolio/featured-images/gal-3-grid.jpg" class="img-grid-v2" alt=" " width="750" height="750"> <a href="gallery-masonry-4-cols.html"> </a></div>
							<div class="item-text-holder-v2">
								<h2 class="item-title display-6"><a href="gallery-masonry-4-cols.html">Angela &amp; Zach</a></h2>
								<ul class="portfolio-categ portfolio-categ-v2">
									<li><a href="#">Wedding</a></li>
								</ul>
							</div>
					...
					<div class="item-portfolio item-portfolio-v2 item-5cols lifestyle wedding">
						<div class="item-portfolio-holder-v2">
							<div class="post-image item-grid-image-v2"><img loading="lazy" src="images/portfolio/featured-images/gal-6-grid.jpg" class="img-grid-v2" alt=" " width="750" height="750"> <a href="gallery-masonry-3-cols.html"> </a></div>
							<div class="item-text-holder-v2">
								<h2 class="item-title display-6"><a href="gallery-masonry-3-cols.html">Clara &amp; Andrew</a></h2>
								<ul class="portfolio-categ portfolio-categ-v2">
									<li><a href="#">Lifestyle</a></li>
									<li><a href="#">Wedding</a></li>
								</ul>
					...
					<div class="item-portfolio item-portfolio-v2 item-5cols lifestyle portrait">
						<div class="item-portfolio-holder-v2">
							<div class="post-image item-grid-image-v2"><img loading="lazy" src="images/portfolio/featured-images/gal-9-grid.jpg" class="img-grid-v2" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div>
							<div class="item-text-holder-v2">
								<h2 class="item-title display-6"><a href="gallery-grid-4-cols.html">Black & White</a></h2>
								<ul class="portfolio-categ portfolio-categ-v2">
									<li><a href="#">Lifestyle</a></li>
									<li><a href="#">Portrait</a></li>
								</ul>
					...
					<div class="item-portfolio item-portfolio-v2 item-5cols portrait">
						<div class="item-portfolio-holder-v2">
							<div class="post-image item-grid-image-v2"><img loading="lazy" src="images/portfolio/featured-images/gal-10-grid.jpg" class="img-grid-v2" alt=" " width="750" height="750"> <a href="gallery-grid-5-cols.html"> </a></div>
							<div class="item-text-holder-v2">
