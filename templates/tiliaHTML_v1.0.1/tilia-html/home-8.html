...
<html lang="en-US">
	...
	<body class="home">
		...
		<div id="wrap-content" class="page-content custom-page-template">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-3">
								...
								<img class="img-fluid radius10 margin-b15" src="images/home/home2-img1.jpg" alt=" " />
								<h5 class="margin-b30">01. We love what we do</h5>
								<img class="img-fluid radius10 margin-b15" src="images/home/home2-img3.jpg" alt=" " />
						...
						<div class="col-lg-3">
								...
								<img class="img-fluid radius10 margin-b15" src="images/home/home2-img2.jpg" alt=" " />
								<h5 class="margin-b30">03. We're storytellers</h5>
								<img class="img-fluid radius10 margin-b15" src="images/home/home2-img4.jpg" alt=" " />
			...
			<!-- SECTION 2 -->
			<div id="home-section-8-2" class="section-holder home-section-8-2 parallax" style="background-image:url(images/pages/contact-page.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="padding-lr200 alignc">
							<h2>We're a dedicated team and we're ready to capture joyful moments that last forever.</h2>
							</div>
						<!-- /padding-lr200 -->
						</div>
						<!-- /col-lg-12 -->
			...
			<!-- SECTION 3 -->
			<div id="home-section-8-3" class="section-holder section-info margin-notop100 padding-tb100 home-section-8-3">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-5 margin-bm50">
							...
							<h2 class="display-4 margin-b30">Selected Work</h2>
							<p>We love photography and travel for meeting new beautiful people all over the world. Propriae voluptaria dissentias nam ei, posse diceret inciderint cum ut, gubergren sadipscing ei vim. Ancillae torquatos in nec, impetus nostrum.</p>
							
							<div class="margin-t30">
								<a href="#" class="read-more">View All Portfolio</a>
							</div>
							</div>
							<!-- /margin-r50 -->	
						</div>
						...
						<div class="col-lg-7">
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-1-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Tracy &amp; Aaron</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-2-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-3-cols.html">Paul &amp; Jane</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-3-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-3-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-masonry-3-cols.html">Angela &amp; Zach</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-4-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-4-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-masonry-4-cols.html">Diana &amp; Max</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-5-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Tina &amp; Robi</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-6-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-justify.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-justify.html">Clara &amp; Andrew</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-7-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-5-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-masonry-5-cols.html">Street People</a></h2><ul class="portfolio-categ"><li><a href="#">Portrait</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-8-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-2-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-masonry-2-cols.html">Ballet Dancers</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-9-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-3-cols.html">Black & White</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li><li><a href="#">Portrait</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-10-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Studio Photos</a></h2><ul class="portfolio-categ"><li><a href="#">Portrait</a></li></ul></div>
								</div>
								<!-- /item-slider -->
							</div>
							<!-- /swiper-wrapper -->
			...
			<!-- SECTION 4 -->
			<div id="home-section-8-4" class="section-holder home-section-8-4">
				<div class="container">
				<div class="row">
					<div class="col-lg-12">
								...
								<div class="testimonial-slider">
									<div class="swiper-wrapper">
										<div class="swiper-slide testimonial-info">
											<h4 class="testimonial-desc">Working with Tilia team sit amet orci eget eros faucibus tincidunt. Duis leo. Sed ringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc vitae ringilla mauris.</h4>
			...
			<!-- SECTION 5 -->
			<div id="home-section-8-5" class="section-holder home-section-8-5 section-info padding-tb100 section-nomargin">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 margin-bm50">
							<div class="el-smalltitle">Get in Touch</div>
							<h2 class="display-4 margin-b30">Book Us for Your Event</h2>
