...
<html lang="en-US">
	<head>
		...
		<title>Gallery Grid 2 Cols - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Gallery Grid 2 Cols</h1>
					<span class="post-subtitle">Photo Shoot</span>
				</div>
			</div>
		</div>
		<!-- /TOP HEADER IMAGE -->
		...
		<div id="wrap-content" class="page-content page-gallery-content">
			...
			<div class="gallery-container">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="portfolio-grid gallery-holder-grid gallery-grid2cols">
							
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-01.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-01.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
							
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-02.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-02.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-03.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-03.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-04.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-04.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-05.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-05.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
								
								<div class="item-portfolio item-2cols gallery-post"> <a href="images/portfolio/gal-grid/gal-grid-06.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-06.jpg" alt="" title="" width="750" height="750"> </a>
								</div><!-- /item-portfolio -->
