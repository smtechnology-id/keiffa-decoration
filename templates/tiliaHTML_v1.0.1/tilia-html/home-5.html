...
<html lang="en-US">
	...
	<body class="home home-5">
		...
		<!-- /HEADER -->
		<!-- HOME SLIDER -->
		<div id="home-slider-5" class="section-holder home-slider-5">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="portfolio-slider gallery-slider-holder">
							<div class="swiper-wrapper">
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-1-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Tracy &amp; Aaron</a></h2>
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-2-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-grid-3-cols.html">Paul &amp; Jane</a></h2>
										<ul class="portfolio-categ">
											<li><a href="#">Wedding</a></li>
										</ul>
									</div>
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-3-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-3-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-masonry-3-cols.html">Angela &amp; Zach</a></h2>
										<ul class="portfolio-categ">
											<li><a href="#">Wedding</a></li>
										</ul>
									</div>
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-4-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-4-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-masonry-4-cols.html">Diana &amp; Max</a></h2>
										<ul class="portfolio-categ">
											<li><a href="#">Wedding</a></li>
										</ul>
									</div>
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-5-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Tina &amp; Robi</a></h2>
										<ul class="portfolio-categ">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-6-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-justify.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-justify.html">Clara &amp; Andrew</a></h2>
										<ul class="portfolio-categ">
											<li><a href="#">Lifestyle</a></li>
											<li><a href="#">Wedding</a></li>
										</ul>
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-7-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-5-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-masonry-5-cols.html">Street People</a></h2>
										<ul class="portfolio-categ">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-8-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-2-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-masonry-2-cols.html">Ballet Dancers</a></h2>
										<ul class="portfolio-categ">
											<li><a href="#">Lifestyle</a></li>
										</ul>
									</div>
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-9-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-grid-3-cols.html">Black & White</a></h2>
										<ul class="portfolio-categ">
											<li><a href="#">Lifestyle</a></li>
											<li><a href="#">Portrait</a></li>
										</ul>
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="images/portfolio/featured-images/gal-10-grid.jpg" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div>
									<div class="item-text-holder">
										<h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Studio Photos</a></h2>
										<ul class="portfolio-categ">
											<li><a href="#">Portrait</a></li>
										</ul>
									</div>
		...
		<div id="wrap-content" class="page-content custom-page-template">
			<!-- SECTION 1 -->
			<div id="home-section-5-1" class="section-holder home-section-5-1">
				<div class="container">
					<div class="row">
			...
			<!-- /SECTION 1 -->	
			<!-- SECTION 2 -->
			<div id="home-section-5-2" class="section-holder home-section-5-2 parallax parallax05" style="background-image:url(images/pages/contact-page.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-md-4">
			...
			<!-- /SECTION 2 -->	
			<!-- SECTION 3 -->
			<div id="home-section-5-3" class="section-holder home-section-5-3">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order2">
							<div class="el-smalltitle">Photo & Video</div>
							<h2 class="display-4 margin-b30">What We Can Do for You</h2>
							...
							<a href="#" class="read-more margin-t30">Read More</a>
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6 order1 margin-bm50">
							<div class="margin-l50">
								<img class="img-fluid radius10" src="images/home/home2-img4.jpg" alt=" " />
							</div>
						</div>
						<!-- /col-lg-6 -->
					</div>
			...
			<!-- /SECTION 3 -->
			<!-- SECTION 4 -->
			<div id="home-section-5-4" class="section-holder home-section-5-4">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 margin-bm50">
							<div class="margin-r50">
								<img class="img-fluid radius10" src="images/home/home2-img2.jpg" alt=" " />
							</div>
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
							<div class="el-smalltitle">Features</div>
							<h2 class="display-4 margin-b30">Our Core Values</h2>
							<p>Veri ubique cu eam, vero dicta ridens ei quo, ex putent menandri accommodare sed. Suscipit lobortis prodesset ut eam. Sale dicta dolore pri et, an aliquam albucius volutpat est.</p>
							<p>Ad graeci theophrastus, libris timeam sapientem. Pellentes faucibus sollicitudin ante,at porta felisrutrum eget. Sed ut nisl urna,e get convallis purus pretium facilisis. Interdum et malesuada varius mauris eu commodo.</p>
							<a href="#" class="read-more margin-t30">Read More</a>
						</div>
			...
			<!-- /SECTION 4 -->
			<!-- SECTION 5 -->
			<div id="home-section-5-5" class="section-holder home-section-5-5 parallax" style="background-image:url(images/pages/contact-page.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
			...
			<!-- /SECTION 5 -->
			<!-- SECTION 6 -->
			<div id="home-section-5-6" class="section-holder home-section-5-6">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 margin-bm50">
