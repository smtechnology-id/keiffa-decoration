...
<html lang="en-US">
	...
	<body class="home home-video">
		...
		<div class="video-container">
			<video id="video" class="video" preload="metadata" playsinline="" autoplay="" muted="" loop="" poster="images/home/video-img.jpg">
		...
		<div id="wrap-content" class="page-content custom-page-template">
			...
			<!-- /SECTION 3 -->	
			<!-- SECTION 4 -->
			<div id="home-section-video-4" class="section-holder home-section-video-4">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="padding-lr200">
								<div class="alignc">
									<div class="el-smalltitle">Contact Us</div>
									<h2 class="display-4 margin-b30">Get in Touch</h2>
								</div>
