...
<html lang="en-US">
	<head>
		...
		<title>Top Header 3 - Tilia </title>
		<!-- Google Fonts -->
		...
		<header class="main-header header-3">
			<div class="container">
				<div class="top-header top-header-3">
					<div class="logo logo-3 logo-white"><a href="index.html"><img class="img-fluid" src="images/logo-tilia.png" alt="Tilia" width="139" height="90"></a></div>
					<div class="logo logo-3 logo-dark"><a href="index.html"><img class="img-fluid" src="images/logo-dark-tilia.png" alt="Tilia" width="139" height="90"></a></div>
