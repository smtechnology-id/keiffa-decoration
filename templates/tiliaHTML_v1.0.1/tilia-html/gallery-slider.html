...
<html lang="en-US">
	<head>
		...
		<title>Gallery Slider - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Gallery Slider</h1>
						...
						<div class="portfolio-slider gallery-slider-holder">
							<div class="swiper-wrapper">
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-01.jpg" alt="" title="" width="750" height="750"></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-02.jpg" alt="" title="" width="750" height="750"></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-03.jpg" alt="" title="" width="750" height="750"></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-04.jpg" alt="" title="" width="750" height="750"> </div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-05.jpg" alt="" title="" width="750" height="750"> </div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-06.jpg" alt="" title="" width="750" height="750"> </div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-07.jpg" alt="" title="" width="750" height="750"> </div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-08.jpg" alt="" title="" width="750" height="750"> </div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image gallery-post"> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-grid-09.jpg" alt="" title="" width="750" height="750"> </div>
								</div>
								<!-- /item-slider -->
							</div>
							<!-- /swiper-wrapper -->
