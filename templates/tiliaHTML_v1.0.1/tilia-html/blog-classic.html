...
<html lang="en-US">
	<head>
		...
		<title>Blog Classic - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg topsinglepage">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Blog Classic</h1>
			...
			<div class="container blog-holder">
				<div class="row">
					<div class="col-lg-9 posts-holder post-sidebar">
						<section class="blog-1col">
							<article class="blog-item blog-item-1col">
								<div class="post-image"> <img src="images/blog/blog-9.jpg" class="img-fluid" alt=" " loading="lazy" width="1400" height="1000"> <a class="cursor-eye" href="blog-single-post.html"></a></div>
								<div class="post-holder post-holder-all">
									<div class="meta-categ-all"><a href="#" rel="category tag">Fashion</a></div>
									<h2 class="article-title"><a href="blog-single-post.html">Into the Forest: Katy Evening Dress</a></h2>
									<div class="meta-info">
										<div class="meta-author"><a href="#"> <img alt="" src="images/gravatar.jpg" class="avatar avatar-25 photo" loading="lazy" width="25" height="25"> April Ryan</a></div>
									...
									<a class="read-more margin-t30" href="single-blog-post.html">Read More</a>
								</div>
							</article>
							<article class="blog-item blog-item-1col">
								<div class="post-image"> <img src="images/blog/blog-8.jpg" class="img-fluid" alt=" " loading="lazy" width="1400" height="1000"> <a class="cursor-eye" href="blog-single-post.html"></a></div>
								<div class="post-holder post-holder-all">
									<div class="meta-categ-all"><a href="#" rel="category tag">Street</a></div>
									<h2 class="article-title"><a href="blog-single-post.html">Jessica & Jake : Love Story in New York</a></h2>
									<div class="meta-info">
										<div class="meta-author"><a href="#"> <img alt="" src="images/gravatar.jpg" class="avatar avatar-25 photo" loading="lazy" width="25" height="25"> April Ryan</a></div>
							...
							<article class="blog-item blog-item-1col">
								<div class="post-image"> <img src="images/blog/blog-7.jpg" class="img-fluid" alt=" " loading="lazy" width="1400" height="1000"> <a class="cursor-eye" href="blog-single-post.html"></a></div>
								<div class="post-holder post-holder-all">
									<div class="meta-categ-all"><a href="#" rel="category tag">Lifestyle</a></div>
									<h2 class="article-title"><a href="blog-single-post.html">Lovely Engagement Photos of Sandra & Peter</a></h2>
									<div class="meta-info">
										<div class="meta-author"><a href="#"> <img alt="" src="images/gravatar.jpg" class="avatar avatar-25 photo" loading="lazy" width="25" height="25"> April Ryan</a></div>
							...
							<article class="blog-item blog-item-1col">
								<div class="post-image"> <img src="images/blog/blog-3.jpg" class="img-fluid" alt=" " loading="lazy" width="1400" height="1000"> <a class="cursor-eye" href="blog-single-post.html"></a></div>
								<div class="post-holder post-holder-all">
									<div class="meta-categ-all"><a href="#" rel="category tag">Fashion</a></div>
									<h2 class="article-title"><a href="blog-single-post.html">Walking by the Sea with Tracy & Aaron</a></h2>
									<div class="meta-info">
										<div class="meta-author"><a href="#"> <img alt="" src="images/gravatar.jpg" class="avatar avatar-25 photo" loading="lazy" width="25" height="25"> April Ryan</a></div>
							...
							<ul>
								<li class="widget widget_block">
									<div>
										...
										<figure><img loading="lazy" src="images/gravatar.jpg" alt="" class="img-fluid" width="500" height="500"></figure>
										...
										<ul>
											<li>
												<div class="display-post-holder">
													<div class="display-post-img"> <a href="blog-single-post.html"><img src="images/blog/blog-9.jpg" class="img-fluid" alt=" " loading="lazy" width="128" height="91"> </a></div>
													<div class="display-post-text">
														<p class="display-post-date">January 11, 2022</p>
														<div class="display-post-title"><a href="blog-single-post.html">Into the Forest: Katy Evening Dress</a></div>
													</div>
												</div>
											</li>
											<li>
												<div class="display-post-holder">
													<div class="display-post-img"> <a href="blog-single-post.html"><img src="images/blog/blog-8.jpg" class="img-fluid" alt=" " loading="lazy" width="128" height="91"> </a></div>
													<div class="display-post-text">
														<p class="display-post-date">January 10, 2022</p>
														<div class="display-post-title"><a href="blog-single-post.html">Jessica &amp; Jake : Love Story in New York</a></div>
													</div>
												</div>
											</li>
											<li>
												<div class="display-post-holder">
													<div class="display-post-img"> <a href="blog-single-post.html"><img src="images/blog/blog-7.jpg" class="img-fluid" alt=" " loading="lazy" width="128" height="91"> </a></div>
													<div class="display-post-text">
														<p class="display-post-date">January 9, 2022</p>
														<div class="display-post-title"><a href="blog-single-post.html">Lovely Engagement Photos of Sandra &amp; Peter</a></div>
													</div>
												</div>
											</li>
											<li>
												<div class="display-post-holder">
													<div class="display-post-img"> <a href="blog-single-post.html" title="Walking by the Sea with Tracy &amp; Aaron"><img src="images/blog/blog-3.jpg" class="img-fluid" alt=" " loading="lazy" width="128" height="91"> </a></div>
													<div class="display-post-text">
														<p class="display-post-date">January 8, 2022</p>
														<div class="display-post-title"><a href="blog-single-post.html">Walking by the Sea with Tracy &amp; Aaron</a></div>
													</div>
												</div>
											</li>
										</ul>
									</div>
									<!-- /widget-display-posts-img -->
								</li>
								<li class="widget widget_block">
									...
									<ul class="wp-block-categories">
										...
										<li class="cat-item"><a href="#">Street</a></li>
									</ul>
								</li>
								<li class="widget widget_block">
									<h5 class="widgettitle">Tags</h5>
									<div class="wp-block-tag-cloud"><a href="#">beach</a> <a href="#">bride</a> <a href="#">couple</a> <a href="#">dress</a> <a href="#">engagement</a> <a href="#" >forest</a> <a href="#">love</a> <a href="#">outdoor</a> <a href="#">photo</a> <a href="#">photos</a> <a href="#">portrait</a> <a href="#">portraits</a> <a href="#">sun</a> <a href="#">wedding</a>
									</div>
								</li>
							</ul>
						</aside>
