...
<html lang="en-US">
	<head>
		...
		<title>Top Header 4 - Tilia </title>
		<!-- Google Fonts -->
		...
		<header class="main-header header-4">
			<div class="container">
				<div class="header-container">
					<div class="logo logo-4 logo-white"><a href="index.html"><img class="img-fluid" src="images/logo-tilia.png" alt="Tilia" width="139" height="90"></a></div>
					<div class="logo logo-4 logo-dark"><a href="index.html"><img class="img-fluid" src="images/logo-dark-tilia.png" alt="Tilia" width="139" height="90"></a></div>
