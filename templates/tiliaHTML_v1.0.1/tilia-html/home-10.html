...
<html lang="en-US">
	...
	<body class="home home-10">
		...
		<div id="wrap-content" class="page-content custom-page-template">
			<!-- SECTION 1 -->
			<div id="home-section-10-1" class="section-holder home-section-10-1 margin-notop100">
							...
							<div id="portfolio-nomargin" class="portfolio-grid-container portfolio-grid-container-v2">
								<div class="portfolio-grid portfolio-grid-v2 portfolio-layout-masonry">
									<div class="item-portfolio item-portfolio-v2 item-2cols wedding">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-portfolio-v2 item-2cols lifestyle wedding">
										<div class="item-portfolio-holder-v2">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-portfolio-v2 item-2cols portrait">
										<div class="item-portfolio-holder-v2">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-portfolio-v2 item-2cols lifestyle">
										<div class="item-portfolio-holder-v2">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-portfolio-v2 item-2cols lifestyle portrait">
										<div class="item-portfolio-holder-v2">
											<div class="post-image item-grid-image-v2"><img loading="lazy" src="images/portfolio/featured-images/gal-9-grid.jpg" class="img-grid-v2" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div>
											<div class="item-text-holder-v2">
									...
									<div class="item-portfolio item-portfolio-v2 item-2cols portrait">
										<div class="item-portfolio-holder-v2">
											<div class="post-image item-grid-image-v2"><img loading="lazy" src="images/portfolio/featured-images/gal-10-grid.jpg" class="img-grid-v2" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div>
											<div class="item-text-holder-v2">
												<h2 class="item-title display-6"><a href="gallery-grid-3-cols.html">Studio Photos</a></h2>
												<ul class="portfolio-categ portfolio-categ-v2">
													<li><a href="#">Portrait</a></li>
												</ul>
											</div>
