...
<html lang="en-US">
	...
	<body class="home">
		...
		<div id="wrap-content" class="page-content page-holder custom-page-template page-full fullscreen-page clearfix">
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 margin-bm50">
							<img class="img-fluid img-circle" src="images/portfolio/gal-grid/gal-grid-13.jpg" alt=" " />
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
			...
			<!-- /SECTION 2 -->
			<!-- SECTION 3 -->
			<div id="aboutme-1-3" class="section-holder aboutme-1-3">
				<div class="container">
