...
<html lang="en-US">
	<head>
		...
		<title>Portfolio Masonry v1 4 Cols - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Portfolio Masonry v1 4 Cols</h1>
					...
					<div class="col-lg-12">
						...
						<div class="portfolio-masonry-container">
							<div class="portfolio-masonry portfolio-layout-masonry">
								...
								<!-- /item-portfolio -->
								<div class="item-portfolio item-4cols lifestyle wedding">
								...
								<!-- /item-portfolio -->
								<div class="item-portfolio item-4cols portrait">
								...
								<!-- /item-portfolio -->
								<div class="item-portfolio item-4cols lifestyle">
								...
								<!-- /item-portfolio -->
								<div class="item-portfolio item-4cols lifestyle portrait">
