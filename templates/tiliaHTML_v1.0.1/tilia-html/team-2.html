	...
	<body class="home">
		...
		<div class="top-single-bkg topsinglepage">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Team 2</h1>
		...
		<div id="wrap-content" class="page-content page-holder custom-page-template page-full fullscreen-page clearfix">
			<!-- SECTION 1 -->
			<div id="team-2-1" class="section-holder team-2-1">
				<div class="container">
			...
			<!-- /SECTION 1 -->
			<!-- SECTION 2 -->
			<div id="team-2-2" class="section-holder team-2-2">
				<div class="container">
					<div class="row">
						...
						<!-- /col-lg-6 -->
						<div class="col-lg-6 margin-bm50 order-mobi1">
							<div class="el-smalltitle">Values</div>
							<h2 class="display-4 margin-b30">We Love What We Do</h2>
							<p>Veri ubique cu eam, vero dicta ridens ei quo, ex putent menandri accommodare sed. Suscipit lobortis prodesset ut eam. Sale dicta dolore pri et, an aliquam albucius volutpat est.</p>
						</div>
						<!-- /col-lg-6 -->
					</div>
			...
			<div id="aboutus-2-3" class="section-holder aboutus-2-3">
				<div class="container section-info radius10 padding-50">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="el-smalltitle">Open Positions</div>
							<h2 class="display-4 margin-b30">We are Looking for New Team Members</h2>
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
							<div class="el-align-right">
								<a href="#" class="read-more">Join Us</a>
							</div>
						</div>
						<!-- /col-lg-6 -->
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-6 col-lg-3 tablet-margin-b30 alignc">
							<h2 class="display-2 margin-b15">2</h2>
