...
<html lang="en-US">
	...
	<body class="home">
		...
		<div class="top-single-bkg topsinglepage">
			<div class="topsingleimg"> <img src="images/pages/img-about1.jpg" alt="" width="1920" height="1080"></div>
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Team 1</h1>
					<span class="post-subtitle"> Professional Photographers &amp; Videographers</span>
				</div>
			</div>
		</div>
		<!-- /TOP HEADER IMAGE -->
		...
		<div id="wrap-content" class="page-content page-holder custom-page-template page-full fullscreen-page clearfix">
			<!-- SECTION 1 -->
			<div id="team-1-1" class="section-holder team-1-1">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 margin-bm50">
							<div class="margin-r50">
								<img class="img-fluid img-circle" src="images/portfolio/gal-grid/gal-grid-08.jpg" alt=" " />
							</div>
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
							...
							<div class="testimonial-client">April Ryan</div>
							<div class="testimonial-company">Founder</div>
			...
			<!-- /SECTION 1 -->
			<!-- SECTION 2 -->
			<div id="team-1-2" class="section-holder team-1-2">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="padding-lr200 alignc">
								...
								<div class="margin-b50">Te vis veniam detracto, tollit alterum graecis his ut. At pro essent aliquip qualisque, vis splendide posidonium ex. Nec quodsi deleniti.</div>
							</div>
						</div>
						<!-- /col-lg-12 -->
					</div>
			...
			<!-- /SECTION 2 -->
			<!-- SECTION 3 -->
			<div id="team-1-3" class="section-holder team-1-3 parallax" style="background-image:url(images/pages/contact-page.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 tablet-margin-b50">
							<div class="el-smalltitle white pcolor-white"> What We Do</div>
							<h2 class="display-4 white margin-b30">Our Skills</h2>
							<p class="white">Veri ubique cu eam, vero dicta ridens ei quo, ex putent menandri accommodare sed. Suscipit lobortis prodesset ut eam. Sale dicta dolore pri et, an aliquam albucius volutpat est.</p>
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
							<div class="margin-l50">
								<div class="progress">
									<div class="progress-bar" role="progressbar" style="width: 95%;" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"><span class="progress-text">Event Shooting</span><span class="progress-percentage">95%</span></div>
								</div>
								<!-- /progress -->
								<div class="progress">
									<div class="progress-bar" role="progressbar" style="width: 85%;" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span class="progress-text">Studio Shooting</span><span class="progress-percentage">85%</span></div>
								</div>
								<!-- /progress -->
								<div class="progress">
									<div class="progress-bar" role="progressbar" style="width: 99%;" aria-valuenow="99" aria-valuemin="0" aria-valuemax="100"><span class="progress-text">Photo Editing</span><span class="progress-percentage">99%</span></div>
								</div>
								<!-- /progress -->
								<div class="progress">
									<div class="progress-bar" role="progressbar" style="width: 90%;" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"><span class="progress-text">Video Editing</span><span class="progress-percentage">90%</span></div>
								</div>
								<!-- /progress -->
								<div class="progress">
									<div class="progress-bar" role="progressbar" style="width: 80%;" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"><span class="progress-text">Editorials</span><span class="progress-percentage">80%</span></div>
								</div>
								<!-- /progress -->
							</div>
							<!-- /margin-l50 -->
			...
			<!-- /SECTION 3 -->
			<!-- SECTION 4 -->
			<div id="team-1-4" class="section-holder team-1-4">
				<div class="container">
