...
<html lang="en-US">
	<head>
		...
		<title>Testimonials 2 - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg topsinglepage">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Testimonials 2</h1>
		...
		<div id="wrap-content" class="page-content page-holder custom-page-template page-full fullscreen-page clearfix">
			<!-- SECTION 1 -->
			<div id="testimonials-2-1" class="section-holder testimonials-2-1">
				<div class="container">
					<div class="row align-items-center margin-b100">
						<div class="col-md-6 mobile-margin-b50">
							<img src="images/portfolio/featured-images/gal-1-grid.jpg" class="img-fluid mask-heart" alt="" loading="lazy" width="750" height="750">
						</div>
						<!-- /col-md-6 -->
						<div class="col-md-6">
							<div class="testimonial-v2">
								...
								<div class="lead margin-b10">Cum ea omnes percipitur cotidieque, propriae suavitate te qui, laudem voluptatibus ne ius. Ut eam lorem consul. Eam bonorum percipit explicari in, efficiendi scripserit ex sed.</div>
								<div class="testimonial-client">Sarah & John</div>
							</div>
						</div>
						<!-- /col-md-6 -->
					</div>
					<!-- /row -->
					<div class="row align-items-center margin-b100">
						<div class="col-md-6 order-mobi2">
							<div class="testimonial-v2">
								<div class="icon-svg icon50">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="icon-quote2" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
										<g>
								...
								<div class="testimonial-client">Kate & Mike</div>
							</div>
						</div>
						<!-- /col-md-6 -->
						<div class="col-md-6 mobile-margin-b50 alignr order-mobi1">
							<img src="images/portfolio/featured-images/gal-3-grid.jpg" class="img-fluid mask-heart" alt="" loading="lazy" width="750" height="750">
						</div>
						<!-- /col-md-6 -->
					</div>
					<!-- /row -->	
					<div class="row align-items-center margin-b100">
						<div class="col-md-6 mobile-margin-b50">
							<img src="images/portfolio/featured-images/gal-6-grid.jpg" class="img-fluid mask-heart" alt="" loading="lazy" width="750" height="750">
						</div>
						<!-- /col-md-6 -->
						<div class="col-md-6">
							<div class="testimonial-v2">
								...
								<div class="testimonial-client">Julia & Robert</div>
							</div>
						</div>
						<!-- /col-md-6 -->
					</div>
					...
					<div class="row align-items-center margin-b100">
						<div class="col-md-6 order-mobi2">
							<div class="testimonial-v2">
								...
								<div class="lead margin-b10">Cu duo minim vocibus menandri, at omittam voluptatum usu. Fabulas docendi iracundia ex cum, viris putant dissentiunt ex cum. Id vim tale mutat, eu vide velit oporteat pri.</div>
								<div class="testimonial-client">Amanda & Andrew</div>
							</div>
						</div>
						<!-- /col-md-6 -->
						<div class="col-md-6 mobile-margin-b50 alignr order-mobi1">
							<img src="images/portfolio/featured-images/gal-2-grid.jpg" class="img-fluid mask-heart" alt="" loading="lazy" width="750" height="750">
						</div>
						<!-- /col-md-6 -->
					</div>
					<!-- /row -->
					<div class="alignc">
						<a href="#" class="read-more">View More Testimonials</a>
					</div>
				</div>
				<!-- /container -->
			</div>
