...
<html lang="en-US">
	<head>
		...
		<title>Gallery FullScreen - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Gallery FullScreen</h1>
		...
		<div id="wrap-content" class="page-content page-gallery-content">
			<div class="gallery-container fullscreen-container fs-gallery">
